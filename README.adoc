...
ifdef::env-github[]
image:https://img.youtube.com/vi/xmSGwipW6NQ/maxresdefault.jpg[link=https://youtu.be/xmSGwipW6NQ&list=PLgZuSc7xewdd9_p_SeFQwJ3PfGJQh3vC_&index=1]
endif::[]
...
ifdef::env-github[]
image:https://i.ytimg.com/vi/P9TRlsyq7gc/maxresdefault.jpg[link=https://youtu.be/P9TRlsyq7gc&list=PLgZuSc7xewdd9_p_SeFQwJ3PfGJQh3vC_&index=2]
endif::[]
...
ifdef::env-github[]
image:https://img.youtube.com/vi/FKdxjjNdCYM/maxresdefault.jpg[link=https://youtu.be/FKdxjjNdCYM&list=PLgZuSc7xewdd9_p_SeFQwJ3PfGJQh3vC_&index=3]
endif::[]

ifndef::env-github[]
video::FKdxjjNdCYM[youtube,list=PLgZuSc7xewdd9_p_SeFQwJ3PfGJQh3vC_]
endif::[]
...
.Konstruktor - Objektorientierte Programmierung in Java 3
ifdef::env-github[]
image:https://img.youtube.com/vi/{youtube-id}/maxresdefault.jpg[link=https://youtu.be/{youtube-id}&list={yt-playlist-id}&index={yt-playlist-index}]
endif::[]
