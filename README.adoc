...
https://youtu.be/xmSGwipW6NQ&list=PLgZuSc7xewdd9_p_SeFQwJ3PfGJQh3vC_&index=1&t=10[Objektorientierung in Java - Objektorientierte Programmierung in Java Teil 1^]
endif::[]
