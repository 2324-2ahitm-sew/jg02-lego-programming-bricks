...
ifdef::env-github[]
image::http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/2324-2ahitm-sew/jg02-lego-programming-bricks/main/plantuml/vehicle-truck-passengercar-cld.puml?token=GHSAT0AAAAAACHTY6ITVSEOVCEX6F7TLVDUZMS7NBA[]
endif::[]
