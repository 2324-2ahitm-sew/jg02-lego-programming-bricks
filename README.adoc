...
ifdef::env-github[]
image:https://img.youtube.com/vi/xmSGwipW6NQ/maxresdefault.jpg[link=https://youtu.be/xmSGwipW6NQ]
endif::[]
...
ifdef::env-github[]
image:https://img.youtube.com/vi/P9TRlsyq7gc/maxresdefault.jpg[link=https://youtu.be/P9TRlsyq7gc]
endif::[]
