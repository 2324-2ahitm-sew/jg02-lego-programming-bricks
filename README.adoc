...
ifdef::env-github[]
image:https://img.youtube.com/vi/P9TRlsyq7gc/maxres2.jpg[link=https://youtu.be/P9TRlsyq7gc&list=PLgZuSc7xewdd9_p_SeFQwJ3PfGJQh3vC_&index=2]
endif::[]
...
ifdef::env-github[]
image:https://img.youtube.com/vi/FKdxjjNdCYM/maxres3.jpg[link=https://youtu.be/FKdxjjNdCYM&list=PLgZuSc7xewdd9_p_SeFQwJ3PfGJQh3vC_&index=3]
endif::[]
